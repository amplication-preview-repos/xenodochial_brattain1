...
@InputType()
class NotificationUpdateManyWithoutDispatchersInput {
...
export { NotificationUpdateManyWithoutDispatchersInput as NotificationUpdateManyWithoutDispatchersInput };
