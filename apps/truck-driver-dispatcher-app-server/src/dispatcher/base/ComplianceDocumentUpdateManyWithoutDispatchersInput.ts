...
@InputType()
class ComplianceDocumentUpdateManyWithoutDispatchersInput {
...
export { ComplianceDocumentUpdateManyWithoutDispatchersInput as ComplianceDocumentUpdateManyWithoutDispatchersInput };
